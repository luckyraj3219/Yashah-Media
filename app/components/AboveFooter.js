    ...
    <section className="bg-white text-black py-12 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          ...
          <p>
            We thrive on creativity and{" "}
            <span className="text-red-500 underline">innovation</span>. Our
            team is constantly exploring new ideas and approaches to ensure your{" "}
